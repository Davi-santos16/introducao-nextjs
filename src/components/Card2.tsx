...
export default function Card ({Description, Title, ImageUrl, category}:CardProps){
    return(
        <div className="bg-green-700 m-2 mt-2 rounded-2xl px-2 py-3 overflow-hidden">
                ...
                <img className="w-full h-50 transition-all duration-70 ease-in-out rounded-2xl hover:scale-110"  src={ImageUrl} alt="Imagem" />

                </div>
                <div className="flex gap-1 mt-2">

                <p className="text-white">Categoria:</p>
                <p className="break-words text-black bg-amber-200 w-20 text-center rounded-2xl">{category}</p>
